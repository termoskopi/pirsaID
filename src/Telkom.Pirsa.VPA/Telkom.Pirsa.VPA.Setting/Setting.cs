namespace Telkom.Pirsa.VPA.Setting
{
    ...
    public class Setting
    {
        ...
        public Setting()
        {
            ...
            TrainingImagesPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
            TestImagesPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
            LogPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
            PreferredImageFormat = System.Drawing.Imaging.ImageFormat.Jpeg;
            RecognizerConfiguration = new RecognizerSetting()
            {
                ClassifierPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments),
                MinimumNeighbour = 10,
